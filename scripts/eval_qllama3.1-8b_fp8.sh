...
quant_data_dvc_dir=quantized/LLaMA3.1-8B/mlperf_submission_slice/W8fA8fKV8f
...
dvc pull $git_dir/furiosa-llm-models-artifacts/$quant_data_dvc_folder/32L/qformat.yaml.dvc -r origin --force
dvc pull $git_dir/furiosa-llm-models-artifacts/$quant_data_dvc_folder/32L/qparam.npy.dvc -r origin --force
...
cp $git_dir/furiosa-llm-models-artifacts/$quant_data_dvc_folder/32L/qformat.yaml $quant_data_dir/calibration_range/quant_format.yaml
cp $git_dir/furiosa-llm-models-artifacts/$quant_data_dvc_folder/32L/qparam.npy $quant_data_dir/calibration_range/quant_param.npy
